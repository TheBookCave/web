...
namespace web.Controllers
{
  public class AccountController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      var accountViewModel = _accountService.GetAccountViewModelByUser(user);
    ...
    public IActionResult Edit()
    {
      ...
      var userEditInputModel = new UserEditInputModel();
      var userId = this.User.FindFirstValue(ClaimTypes.NameIdentifier);

      userEditInputModel.AllBooks = _bookService.GetAllBooks();
      userEditInputModel.AllAddresses = _orderService.GetUserAddresses(userId);
      return View(userEditInputModel);
    }
